...
using MyVirtualAssistant.Bots;
using MyVirtualAssistant.Dialogs;
using MyVirtualAssistant.Models;
using MyVirtualAssistant.Services;
using MyVirtualAssistant.Tests.Utilities;

namespace MyVirtualAssistant.Tests {
